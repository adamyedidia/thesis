...
% once for each.
\supervisor{Scott Aaronson}{Associate Professor}
...
I thank Alex Arkhipov for having introduced me to the pursuit of code golf, as this entire thesis can be thought of as an academic version of code golfing.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% -*-latex-*-
